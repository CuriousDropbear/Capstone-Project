...
```
```{r echo=FALSE, warning=FALSE, message=FALSE}
ggplot(data = prc_month_avg, aes(x = Month_Yr, y = Female_Education_Not_Cybersecurity_month, group = 1)) +
  geom_line() +
  geom_line(aes(y = Cutting_Edge_Computing_month), color = "blue") +
  geom_line(aes(y = US_Cybersecurity_month), color = "red") +
  geom_line(aes(y = UX_month), color = "green")
```
